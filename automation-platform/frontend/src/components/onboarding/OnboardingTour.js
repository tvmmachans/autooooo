...
export const OnboardingTour = () => {
    ...
    if (onboardingComplete)
        return null;
    return (_jsx(Joyride, { steps: steps, run: run, continuous: true, showProgress: true, showSkipButton: true, callback: handleJoyrideCallback, styles: {
            options: {
                primaryColor: '#3b82f6',
                zIndex: 10000,
            },
...
//# sourceMappingURL=OnboardingTour.js.map