...
export class AIVideoNode {
    ...
    async execute(context, input) {
        try {
            ...
            // Generate subtitles
            const subtitles = await this.subtitleService.generateSubtitles(script, audioResult.duration || 60, config.language || 'english', context.userId);
            ...
            }, context.userId, config.title || 'Generated Video');
            return {
                success: true,
                output: {
...
//# sourceMappingURL=AIVideoNode.js.map